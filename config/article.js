export default () => ({ // eslint-disable-line
  ...
  // link file UUID
  id: '9dfe81ee-358e-11e7-bce4-9023f8c0fd2e',

  // canonical URL of the published page
  // https://ig.ft.com/london-pollution get filled in by the ./configure script
  url: 'https://ig.ft.com/london-pollution',

  // To set an exact publish date do this:
  //       new Date('2016-05-17T17:11:22Z')
  publishedDate: new Date(),

  headline: 'London air pollution headline',
  ...
  topic: {
    ...
    url: 'https://www.ft.com/visual-journalism/',
  },
